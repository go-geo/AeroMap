...
XString DEM::median_smoothing(XString geotiff_path, XString output_path, int smoothing_iterations, int window_size, int num_workers)
{
	...
	{
		Logger::Write(__FUNCTION__, "File does not exist: '%s'", geotiff_path.c_str());
		assert(false);
	}
