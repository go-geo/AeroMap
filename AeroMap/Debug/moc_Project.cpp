...
QT_MOC_LITERAL(1, 8, 18), // "projectChanged_sig"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "Project\0projectChanged_sig\0"
};
...
void Project::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->projectChanged_sig(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Project::projectChanged_sig)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Project::projectChanged_sig()
{
