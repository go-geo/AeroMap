...
QT_MOC_LITERAL(1, 5, 15), // "tool_change_sig"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Tool\0tool_change_sig\0"
};
...
void Tool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->tool_change_sig(); break;
        default: ;
        }
        ...
        {
            using _t = void (Tool::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tool::tool_change_sig)) {
                *result = 0;
                return;
            }
        }
