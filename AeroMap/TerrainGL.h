...
#include "ScaleColor.h"			// color scale manager
...
public:
	...
	static constexpr char* SCALE_GRAY = "Grayscale";		// reserved color scale options
	static constexpr char* SCALE_ORTHO = "Orthophoto";
...
public:
	...
	void SetColorScale(XString scale_file);
	void ClearColorScale();
	void SetTextureFile(XString texture_file);
